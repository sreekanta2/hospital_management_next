...
export default function FavouriteDoctorCard() {
  return (
    <section className="border rounded-md w-full text-gray-600 dark:text-gray-400 dark:bg-gray-800  py-4 px-2">
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <p className="text-sm text-center font-sans bg-slate-100 dark:bg-gray-950 dark:text-gray-300 px-4 py-2 rounded-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-4 gap-2 items-center">
        <CustomLink
          href="#"
          className="border  bg-slate-100 dark:bg-gray-950 dark:text-gray-300 "
        >
          View Details
        </CustomLink>
        <CustomLink
